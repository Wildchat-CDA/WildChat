...
var Section = function () {
    ...
    var Section = _classThis = /** @class */ (function () {
        function Section_1() {
            ...
            this.channels = (__runInitializers(this, _order_extraInitializers), __runInitializers(this, _channels_initializers, void 0));
            __runInitializers(this, _channels_extraInitializers);
        }
        return Section_1;
    }());
    __setFunctionName(_classThis, "Section");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _id_decorators = [(0, typeorm_1.PrimaryGeneratedColumn)()];
        _title_decorators = [(0, typeorm_1.Column)({ length: 150 })];
        _order_decorators = [(0, typeorm_1.Column)()];
        _channels_decorators = [(0, typeorm_1.ManyToMany)(function () { return channel_entity_1.Channel; }, function (channel) { return channel.sections; }, {
                cascade: true,
        ...
        Section = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return Section = _classThis;
}();
