...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.firstName = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _firstName_initializers, void 0));
            ...
            this.channels = (__runInitializers(this, _role_extraInitializers), __runInitializers(this, _channels_initializers, void 0));
    ...
    (function () {
        ...
        _firstName_decorators = [(0, typeorm_1.Column)({ length: 150 })];
        _email_decorators = [(0, typeorm_1.Column)({ length: 150 })];
        _password_decorators = [(0, typeorm_1.Column)({ length: 150 })];
        _role_decorators = [(0, typeorm_1.ManyToOne)(function () { return role_entity_1.Role; }, function (role) { return role.users; })];
        _channels_decorators = [(0, typeorm_1.ManyToMany)(function () { return channel_entity_1.Channel; }), (0, typeorm_1.JoinTable)()];
