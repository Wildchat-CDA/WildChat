...
export class StudentService {
  ...
  private generateMockStudents(): void {
    const mockStudents: Student[] = [
      ...
      { id: uuidv4(), name: 'Martin', firstName: 'Thomas', email: 'thomas.martin@email.com', password: 'password@456', onLine: false },
      { id: uuidv4(), name: 'Leroy', firstName: 'Emma', email: 'emma.leroy@email.com', password: 'Password@789', onLine: false},
      { id: uuidv4(), name: 'Moreau', firstName: 'Lucas', email: 'lucas.moreau@email.com', password: 'Password@ab54', onLine: false },
      ...
      { id: uuidv4(), name: 'Fournier', firstName: 'Léa', email: 'lea.fournier@email.com', password: 'Password@76k', onLine: true },
      { id: uuidv4(), name: 'Girard', firstName: 'Nathan', email: 'nathan.girard@email.com', password: 'Password@09', onLine: true },
